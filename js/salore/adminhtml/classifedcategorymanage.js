...
CategoryManagement.prototype = {
		...
		$$('a[href="#classifed-category-edit"]').each(function(item){
			Event.observe(item, 'click', me.onClick.bind(me, item));
		});
		$$('a[href="#classifed-category-delete"]').each(function(item){
			Event.observe(item, 'click', me.onClick.bind(me, item));
		});
	...
	onClick: function(obj)
	{
		...
		if(obj.hasClassName('classifed-category-edit'))
		{
			this.edit(obj);
		}
		if(obj.hasClassName('classifed-category-delete'))
		{
