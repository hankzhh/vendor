var CityImageManagement = Class.create();
CityImageManagement.prototype = {
		itemId: null,
		editUrl: null,
		deleteUrl: null,
		messageDelete: null,
		...
		$$('a[href="#salon-city-edit"]').each(function(item){
			Event.observe(item, 'click', me.onClick.bind(me, item));
		});
		$$('a[href="#salon-city-delete"]').each(function(item){
			Event.observe(item, 'click', me.onClick.bind(me, item));
		});
	...
	onClick: function(obj)
	{
		...
		if(obj.hasClassName('salon-city-edit'))
		{
			this.edit(obj);
		}
		if(obj.hasClassName('salon-city-delete'))
		{
