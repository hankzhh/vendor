 ...
 */
class Salore_Salon_Adminhtml_CategoryController extends Mage_Adminhtml_Controller_Action
{
    public function _initData() {
        $category_id = $this->getRequest()->getParam('id');
        Mage::register('category_data', Mage::getModel('salon/category'));
    ...
    public function editAction() {
        ...
        ->_addContent ( $this->getLayout ()->createBlock ( 'salon/adminhtml_category_edit' ) )
        ->renderLayout();
    }
    public function saveAction() {
        $this->_initData();
        $data = $this->getRequest()->getParams();
        $categoryObj = Mage::getModel('salon/category');
        if(isset($data) && $data)
        {
            if(isset($data['id']) && $data['id']) {
                ...
                $categoryModel = Mage::getModel('salon/category');
            ...
            if(isset($data['category_name']) && $data['category_name']) {
                $categoryObj->setData('category_name' ,$data['category_name']);
            }
            ...
            if(isset($_FILES['img_category']['name']) && $_FILES['img_category']['name'] ) {
                ...
                $path = Mage::getBaseDir('media').DS.'salon'.DS.'category'.DS ;
                $pathDelete = Mage::getBaseDir('media').DS.'salon'.DS.'category'.DS .$categoryImage;
                $categoryUrl = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_WEB) . 'media/' . 'salon/' .'category'. '/'  ;
                $categoryurlResize = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_WEB) . 'media/' . 'salon/' .'category'. '/' .$categoryImage ;
    ...
    public function ajaxdeleteAction() {
        ...
        try {
            $categoryModel = Mage::getModel('salon/category')->load($id, 'entity_id');
