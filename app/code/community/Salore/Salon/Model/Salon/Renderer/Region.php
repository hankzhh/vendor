 ...
 */
class Salore_Salon_Model_Salon_Renderer_Region implements Varien_Data_Form_Element_Renderer_Interface {
    /**
    ...
    public function render(Varien_Data_Form_Element_Abstract $element) {
        ...
        if ($regionCollection && count($regionCollection) > 0) {
            ...
            $html .= '<input style="display: none;" type="text"  name="' . $regionHtmlName . '" id="' . $regionHtmlId . '" value="" class="input-text"/>';
            $html .= '<script type="text/javascript">
            //<![CDATA[
                new RegionUpdater(\'country_id\', \''.$regionHtmlId.'\', \''.$regionIdHtmlId.'\','.Mage::helper('directory')->getRegionJson().', undefined, \'zip\');
            //]]>
            </script>';
            $html.= '</td>';
            ...
            $html .= '<select name="' . $regionIdHtmlName . '" id="' . $regionIdHtmlId . '"></select>';
            $html .= '<script type="text/javascript">
            //<![CDATA[
                new RegionUpdater(\'country_id\', \''.$regionHtmlId.'\', \''.$regionIdHtmlId.'\','.Mage::helper('directory')->getRegionJson().', undefined, \'zip\');
            //]]>
