 ...
 */
class Salore_Salon_Model_Resource_Salon_Collection extends Salore_Mongo_Model_Resource_Collection_Abstract {
    protected $_itemObjectClass = 'Salore_Salon_Model_Salon';
