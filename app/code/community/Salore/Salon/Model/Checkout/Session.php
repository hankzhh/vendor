 ...
 */
class Salore_Salon_Model_Checkout_Session extends Mage_Checkout_Model_Session {
    ...
    public function getQuote() {
        ...
        if ($this->_quote === null) {
            ...
            $quote = Mage::getModel('sales/quote')->setStoreId(Mage::app()->getStore($this->getCheckoutStoreId())->getId());
            if ($this->getQuoteId()) {
                ...
                if ($quote->getId()) {
                     ...
                     * store switcher.
                     */
                    if ($quote->getQuoteCurrencyCode() != Mage::app()->getStore($this->getCheckoutStoreId())->getCurrentCurrencyCode()) {
                        $quote->setStore(Mage::app()->getStore($this->getCheckoutStoreId()));
    ...
    protected function _getQuoteIdKey() {
        return 'quote_id_' . Mage::app()->getStore($this->getCheckoutStoreId())->getWebsiteId();
    }
    ...
    public function loadCustomerQuote() {
        ...
        ->setStoreId(Mage::app()->getStore($this->getCheckoutStoreId())->getId())
